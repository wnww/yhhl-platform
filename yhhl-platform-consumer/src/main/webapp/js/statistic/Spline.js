var dataString='<chart palette="3" caption="Monthly Sales Summary" subcaption="For the year 2006" xAxisName="Month" yAxisMinValue="15000" yAxisName="Sales" numberPrefix="$" showValues="0">\n\
